...
function Location() {
  return (
    <div>
      <div className="max-w-[962px] w-full min-h-[108px] mb-[104px] flex sm:flex-row flex-col flex-wrap items-center mt-[145px] bg-[#2C49FEBD] sm:rounded-[100px] rounded-[84px] px-[35px] py-[17px] justify-between gap-[10px]">
        <div className="location flex flex-row items-center justify-center gap-[17px]">
            <div className="svg">
...
<path d="M15.4993 2.58337C12.7588 2.58337 10.1305 3.67206 8.19258 5.60994C6.2547 7.54781 5.16602 10.1761 5.16602 12.9167C5.16602 15.3605 5.68527 16.9596 7.10352 18.7292L15.4993 28.4167L23.8952 18.7292C25.3134 16.9596 25.8327 15.3605 25.8327 12.9167C25.8327 10.1761 24.744 7.54781 22.8061 5.60994C20.8682 3.67206 18.2399 2.58337 15.4993 2.58337V2.58337Z" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <div className="text-area">
                <p className='font-[Yantramanav] leading-full text-[20px] font-[500] text-white'>Location</p>
                <p className='font-[Yantramanav] leading-full text-[14px] font-[400] text-[#FFFFFFB2]'>Search by city</p>
            </div>
        </div>
        
        <div className="sm:w-[3px] sm:h-[40px] bg-white w-[164px] h-[3px]"></div>
        
        <div className="date flex flex-row items-center justify-center gap-[17px]">
            <div className="svg">
            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="31" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
  <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5M1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
</svg>

            </div>
            <div className="text-area">
                <p className='font-[Yantramanav] leading-full text-[20px] font-[500] text-white'>Date</p>
                <p className='font-[Yantramanav] leading-full text-[14px] font-[400] text-[#FFFFFFB2]'>09/23/2021</p>
            </div>
        </div>
        
        <div className="sm:w-[3px] sm:h-[40px] bg-white w-[164px] h-[3px]"></div>
        
        <div className="capacity flex flex-row items-center justify-center gap-[17px]">
            <div className="svg">
...
<path d="M25 17.5H25.3825C25.9743 17.4999 26.5469 17.7098 26.9985 18.0923C27.4501 18.4747 27.7514 19.005 27.8487 19.5887L28.265 22.0887C28.3247 22.4469 28.3057 22.8138 28.2093 23.1639C28.1129 23.514 27.9413 23.8389 27.7066 24.116C27.4719 24.393 27.1796 24.6156 26.8501 24.7683C26.5207 24.921 26.1619 25 25.7987 25H21.25" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <div className="text-area">
                <p className='font-[Yantramanav] leading-full text-[20px] font-[500] text-white'>Capicity</p>
                <p className='font-[Yantramanav] leading-full text-[14px] font-[400] text-[#FFFFFFB2]'>Search by city</p>
            </div>
        </div>
        
        <Button text="GO CHECK" className="rounded-4xl px-[40px] text-[20px] rounded-[100px] py-[20px] font-[600] bg-[#FFFFFF] text-[#2C49FE]"/>
      </div>
    </div>
  )
}
