...
function EventsCard() {
  return (
    <div>
      <div className="card flex flex-col border border-[#CCCCCC] rounded-3xl p-[37px] max-md:p-[15px] w-full">
                            <div className="w-full max-h-[252px] overflow-hidden relative">
                                <img src="./assets/rect.jpg" alt="" className="w-full z-[-2] h-full rounded-3xl object-cover" />
                            </div>
                            <div className="text-container font-[Poppins] mt-[21px]">
                                <div className="title font-bold text-[24px] mb-[12px]">
                                    Lorem ipsum dolar sit de
                                </div>
                                <div className="text-[#666666] flex flex-col items-start gap-[14px]">
                                    ...
                                    <div className="flex items-center gap-[6px]">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_102326_411)">
                                                <path
                                    ...
                                    <div className="flex items-center gap-[6px]">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_102326_392)">
                                                <path
                                ...
                                <div className="button-area mt-[32px]">
                                    <button
                                        className="py-[11px] px-[28px] bg-[#2C49FE] text-white font-bold text-[16px] rounded-4xl">
                                        Go Check
                                    </button>
                                </div>
                            </div>
