...
function Footer() {
  return (
    <div>
        <div className="footer bg-[#000000] mx-auto w-full ">
            <footer
                className="max-w-[1322px] pt-[40px] md:pt-[81px] justify-between ml-auto mr-auto flex flex-col lg:flex-row max-h-auto lg:max-h-[372px] w-[100%] relative overflow-hidden px-4 md:px-0">

                <div className="side-1 flex flex-col items-start mb-8 lg:mb-0">
                    <ul>
                        <li
                            className=" items-center font-bold gap-[10px] md:gap-[15px] flex flex-row font-[Poppins] text-[24px] md:text-[36px] text-[#01C8FF]">
                            <span><img src="./assets/logo.png" alt="" className="max-h-[44px] md:max-h-[66px] h-[100%] w-full max-w-[65px] md:max-w-[98px]" /></span><span
                                className="text-[#2C49FE] font-[Poppins] text-[24px] md:text-[36px]">Events</span>Free
                        </li>
                        <li className="max-w-[346px] pt-[20px] md:pt-[36px] text-white text-sm md:text-base">Lorem ipsum
                            dolor sit amet, consectetur
                            adipiscing elit. Nunc efficitur urna in dictum suscipit. Suspendisse maximus
                            ipsum sem. c</li>
                        <li className="socials flex gap-[10px] md:gap-[15px] pt-[16px] md:pt-[24px]">
                            <div className="svg">
                                <a href="https://instagram.com" target="_blank"><svg width="23" height="23"
                ...
                <div className="side-2 flex flex-col sm:flex-row gap-[30px] md:gap-[74px] w-full lg:w-auto">
                    <ul className="text-white font-[Poppins]">
                        <li className="font-bold text-sm md:text-base mb-2 md:mb-3">SERVICES</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">About</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">News</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">ullamcorper</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">Contact</li>
                    </ul>
                    <ul className="text-white font-[Poppins]">
                        <li className="font-bold text-sm md:text-base mb-2 md:mb-3">EVENTS</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">ullamcorper</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">ullamcorper</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">ullamcorper</li>
                        <li className="text-xs md:text-sm mb-1 md:mb-2">ullamcorper</li>
                    ...
                    <ul className="w-full sm:w-auto">
                        ...
                        <div className="footer-gallery-grid grid grid-cols-2 sm:grid-cols-3 gap-[8px] md:gap-[13px] max-w-[300px] w-full">
                            ...
                            <img src="./assets/bg-4.jpg" alt="" className="w-full h-[50px] md:h-[62px] object-cover rounded" />
                            <img src="./assets/bg-5.jpg" alt="" className="w-full h-[50px] md:h-[62px] object-cover rounded" />
                            <div
                                className="w-full h-[50px] md:h-[62px] bg-[#18205C] rounded flex items-center justify-center">
                                <button className="text-white text-xs font-bold">Show More</button>
                            </div>
                        </div>
                    </ul>
                </div>
            ...
            <div className="foot mt-[40px] md:mt-[95px] text-white text-center px-4 pb-4">
                <p className="text-xs md:text-sm">© Credits of companyName belong to companyName.</p>
            </div>
    </div>
    </div>
  )
